...
public class Q4 {
    public static void main(String[] args) {
        writeFile();
        DivideF1 a = new DivideF1("src/WIX1002_2021_1/data.dat");
        DivideF2 b = new DivideF2("src/WIX1002_2021_1/data.dat");
        display(a);
        display(b);
    }
    ...
    public static void writeFile() {
        try {
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("src/WIX1002_2021_1/data.dat"));
            out.writeInt(53434);
            out.writeInt(1033);
            out.writeInt(1353);
            out.writeInt(190817);
