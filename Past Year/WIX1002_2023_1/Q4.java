...
public class Q4 {
    public static void main(String[] args) {
        try{
            Scanner input = new Scanner(new FileInputStream("src/WIX1002_2022_1/nodelist.txt"));
            String line;
            String[] extract;
            int noNode = 0;
            ...
            input = new Scanner(new FileInputStream("src/WIX1002_2022_1/nodelist.txt"));
