...
public class Q3 {
    ...
    public static void writeFile(String string) {
        try {
            PrintWriter out = new PrintWriter(new FileOutputStream("src/WIX1002_2017_1/data.txt"));
            out.print(string);
            out.close();
        } catch (IOException e) {
    ...
    public static String readString() {
        ...
        try {
            Scanner in = new Scanner(new FileInputStream("src/WIX1002_2017_1/data.txt"));
