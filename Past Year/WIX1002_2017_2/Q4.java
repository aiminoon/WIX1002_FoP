...
public class Q4 {
    public static void main(String[] args) {
        generateFile();
        try {
            ObjectInputStream input = new ObjectInputStream(new FileInputStream("src/WIX1002_2017_2/Q4.dat"));
    ...
    public static void generateFile() {
        try {
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("src/WIX1002_2017_2/Q4.dat"));
